...
/**
 * Provides the local service interface for GKartCategory. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Valiyullah
 * @see GKartCategoryLocalServiceUtil
...
public interface GKartCategoryLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link GKartCategoryLocalServiceUtil} to access the g kart category local service. Add custom service methods to {@link com.liferay.sample.service.impl.GKartCategoryLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
