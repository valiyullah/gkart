...
/**
 * Provides the local service interface for GKartItems. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Valiyullah
 * @see GKartItemsLocalServiceUtil
...
public interface GKartItemsLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link GKartItemsLocalServiceUtil} to access the g kart items local service. Add custom service methods to {@link com.liferay.sample.service.impl.GKartItemsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
